...
module DhanTradingAgentTools
  ...
  SUPER_ORDER_TOOLS = [
    { name: :place_bracket_order, description: "Place bracket order (entry + target + stop-loss)", api: "POST /v2/super/orders" },
    ...
    { name: :cancel_super_order_leg, description: "Cancel specific leg of super order", api: "DELETE /v2/super/orders/:order_id/:leg" },
  ].freeze
  ...
  MARKET_DATA_TOOLS = [
    ...
    { name: :get_historical_intraday, description: "Get intraday historical data (1min to 60min candles)", api: "POST /v2/charts/intraday" },
  ...
  ANALYSIS_TOOLS = [
    { name: :calculate_support_resistance, description: "Calculate support and resistance levels using historical data" },
