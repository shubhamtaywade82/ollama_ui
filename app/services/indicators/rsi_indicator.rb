...
module Indicators
  ...
  class RsiIndicator < BaseIndicator
    ...
    def calculate_at(index)
      ...
      # Use existing CandleSeries#rsi method (uses RubyTechnicalAnalysis or TechnicalAnalysis gem)
    ...
    def create_partial_series(index)
      ...
      # Uses existing CandleSeries#rsi which leverages technical analysis gems
