...
module Indicators
  ...
  class MacdIndicator < BaseIndicator
    ...
    def calculate_at(index)
      ...
      # Use existing CandleSeries#macd method (uses RubyTechnicalAnalysis or TechnicalAnalysis gem)
    ...
    def create_partial_series(index)
      ...
      # Uses existing CandleSeries#macd which leverages technical analysis gems
